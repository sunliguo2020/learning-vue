...
const _sfc_main = {
  ...
  setup(__props) {
    const goPreview = (id) => {
      common_vendor.index.setStorageSync("storageClissList", randomList.value);
    ...
    const wallNewsList = common_vendor.ref([]);
    ...
    const getRandomList = async () => {
      let res = await api_apis.apiGetRandomList();
    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: common_vendor.f(wallNewsList.value, (item, k0, i0) => {
          return {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-1cf27b2a"], ["__file", "F:/github/learning-vue/uniapp/HBuilderProjects/wallpaper/pages/index/index.vue"]]);
